...
5. Click on **Create stack** (_With new resources (Standard)_ if you have clicked at the top right corner).
...
10. Click **Next**.
11. Provide a **Stack name**. For example _cfn-workshop-s3_. 
...
2. Update the stack as per demo bellow:

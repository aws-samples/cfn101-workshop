...
Choose to [install](https://aws-ia.github.io/taskcat/docs/INSTALLATION.html) `taskcat` with `pip`:
...
If needed, choose to delete the `~/.taskcat.yml` file you created in your home directory as well.

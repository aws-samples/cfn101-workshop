...
5. It’s now time to create your stack! Follow steps below:
    ...
    :::code{language=shell showLineNumbers=false showCopyAction=true}
    aws cloudformation create-stack --stack-name cfn-workshop-dynamic-references-ec2 --template-body file://ec2-instance.yaml
    :::
    ...
    5. Enter a Stack name. For example, `cfn-workshop-dynamic-references-ec2`.
    6. Choose to use default values for **Configure stack options**, and choose **Next**.
    7. On the **Review <stack_name>** page for your stack, scroll down to the bottom, and choose **Submit**.
    8. Wait for stack status to reach the **CREATE_COMPLETE**. You need to periodically select Refresh to see the latest stack status.
	::::
    :::::
...
2. To deploy the Database stack, follow the steps below:
    ...
    :::code{language=shell showLineNumbers=false showCopyAction=true}
    aws cloudformation create-stack --stack-name cfn-workshop-dynamic-references-database \
    ...
    5. Enter a Stack name. For example, `cfn-workshop-dynamic-references-database`.
    ...
    9. On the **Review <stack_name>** page for your stack, scroll down to the bottom, and choose **Submit**.
    10. Wait for stack status to reach the **CREATE_COMPLETE**. You need to periodically select Refresh to see the latest stack status.
    ::::
    :::::
...
4. To Deploy the Lambda stack, follow the steps below:
    ...
    :::code{language=shell showLineNumbers=false showCopyAction=true}
    aws cloudformation create-stack --stack-name cfn-workshop-dynamic-references-lambda \
    ...
    5. Enter a Stack name. For example, `cfn-workshop-dynamic-references-lambda`, and choose **Next**.
    6. Choose to use default values for **Configure stack options**, and choose **Next**.
    7. On the **Review <stack_name>** page, scroll down to the bottom and tick **I acknowledge that AWS CloudFormation might create IAM resources** check box, then click on **Submit**.
    8. Wait for stack status to reach the **CREATE_COMPLETE**. You need to periodically select Refresh to see the latest stack status.
    ::::
    :::::
